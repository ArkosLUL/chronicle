...
const (
	...
	UniqueLogInstanceEncounterCharacterFightPkey    UniqueConstraint = "log_instance_encounter_character_fight_pkey"     // ALTER TABLE ONLY log_instance_encounter_character_fight ADD CONSTRAINT log_instance_encounter_character_fight_pkey PRIMARY KEY (encounter_id, id);
