...
const (
	UniqueEncounterDamageUnitsSummaryPkey UniqueConstraint = "encounter_damage_units_summary_pkey" // ALTER TABLE ONLY encounter_damage_units_summary ADD CONSTRAINT encounter_damage_units_summary_pkey PRIMARY KEY (encounter_id, unit_guid);
