...
func TestZulFarrakHostiles_BossCoverage(t *testing.T) {
	...
	require.True(t, hostiles[5648].Affiliation)
	require.False(t, hostiles[5648].Boss)
	require.True(t, hostiles[7797].Affiliation)
	require.False(t, hostiles[7797].Boss)
	require.False(t, hostiles[7604].Affiliation)
	require.False(t, hostiles[12999].Affiliation)
}
