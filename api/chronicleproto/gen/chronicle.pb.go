...
var file_chronicle_proto_depIdxs = []int32{
	...
	1, // 3: chronicleproto.InstanceService.Damage:input_type -> chronicleproto.InstanceRequest
	3, // 4: chronicleproto.InstanceService.Damage:output_type -> chronicleproto.DamageReport
