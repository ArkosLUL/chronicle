...
func TestParseCast(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:     "Object casting without name",
			input:    "CAST: 0xF11002B6284CB931() casts Conflagration(19428) on 0x0000000000001D0C(Porkins).",
			expError: false,
			exp: castv2.CastV2{
				Caster: types.Unit{
					Name: "",
					Gid:  0xF11002B6284CB931,
				},
				Action: types.CastActionsCasts,
				Target: &types.Unit{
					Name: "Porkins",
					Gid:  0x0000000000001D0C,
				},
				Spell: types.Spell{
					Name: "Conflagration",
					ID:   19428,
