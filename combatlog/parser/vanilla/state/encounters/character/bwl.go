...
func NewNefarian(id guid.GUID, all *Characters) (Character, bool) {
	...
	return NewRoomMechanic(id, 11583, all)
}
...
func NewBroodlordLashlayer(id guid.GUID, all *Characters) (Character, bool) {
	return NewAdsGoWithBoss(12017,
...
func NewRazorgore(id guid.GUID, all *Characters) (Character, bool) {
	...
	c := &razorgore{Common: NewCommonCharacter(id, all)}
	return NewAdsGoWithBossCustomCharacter(c, all, 12435,
		12420,
		12416,
		12422,
		50142,
