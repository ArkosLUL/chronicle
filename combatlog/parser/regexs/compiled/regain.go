...
// Code generated by regengo for pattern: (.+[^\s]) (gains|loses) (\d+) (Health|health|Mana|Rage|Energy|Happiness|happiness|Focus) from (.+[^\s])'s (.+[^\s])\.
// DO NOT EDIT.
...
Ins100:
	{
		stack = append(stack, [3]int{offset, 99, 0})
		goto Ins101
	}
Ins101:
	{
