...
const PANEL_CATEGORIES: PanelCategory[] = [
  ...
  {
    label: "Utility",
    items: ["roles", "timeline", "rotations", "comparison", "all_activity", "metrics", "periods", "possession", "unit_lookup", "equipment", "guilds", "loot", "logging_metadata", "companion_stats", "leaderboard", "empty"],
